    ...
    <div className='flex flex-col min-h-screen'>
      ...
      <header className='px-4 lg:px-6 h-14 flex items-center justify-between max-w-7xl mx-auto w-full bg-background'>
        <Link className='flex items-center justify-center' href='#'>
          ...
          <span className='ml-2 text-2xl font-bold text-spotify'>
            TrackKeeper
          </span>
        </Link>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align='end'>
            ...
            <DropdownMenuItem asChild>
              <Link className='w-full' href='#how-it-works'>
                How It Works
              </Link>
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
          ...
          <div className='container px-4 md:px-6 max-w-6xl mx-auto'>
            ...
            <div className='grid gap-6 lg:grid-cols-3 lg:gap-12'>
              <Card>
                <CardHeader>
                  <CardTitle className='flex items-center gap-2'>
                    <SpotifyFilled className='text-spotify' /> Spotify
                    Integration
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className='flex items-center gap-2'>
                    <Binoculars className='text-spotify' />
                    Track Monitoring
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className='flex items-center gap-2'>
                    <ListVideo className='text-spotify' /> Playlist Creation
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p>
        ...
        <section id='how-it-works' className='w-full py-12 md:py-24 lg:py-32'>
          <div className='container px-4 md:px-6 max-w-6xl mx-auto'>
            ...
            <div className='grid gap-6 lg:grid-cols-3 lg:gap-12 items-start'>
              ...
              <div className='flex flex-col items-center space-y-2 border-border p-4 rounded-lg'>
                <ListMusic className='h-12 w-12 text-spotify' />
              ...
              <div className='flex flex-col items-center space-y-2 border-border p-4 rounded-lg'>
                <RefreshCcw className='h-12 w-12 text-spotify' />
